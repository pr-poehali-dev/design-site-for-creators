...
const Index = () => {
  ...
  const services = [
    ...
    },
    {
      icon: 'Sparkles',
      title: 'Моушн-дизайн',
      description: 'Анимация графики, текста и визуальных эффектов для видео'
    }
  ];
  ...
  return (
    <div className="min-h-screen relative" style={{ backgroundImage: 'url(https://cdn.poehali.dev/files/cc454bf1-def7-4062-af72-0f08ab471c1d.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Привет! Я — креативный видеограф и фотограф, специализирующийся на создании вирусного контента для социальных сетей.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
