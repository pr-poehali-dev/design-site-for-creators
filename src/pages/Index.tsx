          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Привет! Я — Виктория, твой личный и креативный контент-мейкер, специализирующийся на создании современного качественного контента для социальных сетей. Моя миссия — помогать брендам и личностям рассказывать их истории через мощные визуальные образы. Каждый проект для меня — это возможность создать что-то уникальное.
              </p>
